...
class Testcases(unittest.TestCase):
    ...
    def test_authorperm_resolve(self):
        self.assertEqual(resolve_authorperm('https://dvideo.io/#!/v/pottlund/m5cqkd1a'),
                         ('pottlund', 'm5cqkd1a'))
        self.assertEqual(resolve_authorperm("https://dsite.io/witness-category/@gtg/24lfrm-gtg-witness-log"),
