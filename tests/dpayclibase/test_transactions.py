...
class Testcases(unittest.TestCase):
    ...
    def doit(self, printWire=False, ops=None):
        ...
        tx.verify([PrivateKey(wif, prefix=u"DWB").pubkey], prefix)
    ...
    def test_escrow_transfer(self):
        self.op = operations.Escrow_transfer(
            **{
                "from": "alice",
                "to": "bob",
                "bbd_amount": {"amount": "1000", "precision": 3, "nai": "@@000000013"},
                "dpay_amount": {"amount": "0", "precision": 3, "nai": "@@000000021"},
                "escrow_id": 23456789,
                "agent": "charlie",
    ...
    def test_escrow_release(self):
        self.op = operations.Escrow_release(
            **{
                ...
                "who": "charlie",
                "escrow_id": 72526562,
                "bbd_amount": {"amount": "5000", "precision": 3, "nai": "@@000000013"},
                "dpay_amount": {"amount": "0", "precision": 3, "nai": "@@000000021"},
                "prefix": default_prefix,
            })
    ...
    def test_claim_reward_balance(self):
        self.op = operations.Claim_reward_balance(
            **{
                "account": "alice",
                "reward_dpay": {"amount": "17", "precision": 3, "nai": "@@000000021"},
                "reward_bbd": {"amount": "11", "precision": 3, "nai": "@@000000013"},
        ...
        self.op = operations.Account_create_with_delegation(
            **{
                ...
                "owner": {
                    ...
                    "key_auths": [
                        [
                            "DWB5Tki3ecCdCCHCjhhwvQvXuKryL2s34Ma6CXsRzntSUTYVYxCQ9",
                            1
                        ]
                    ]
                },
                "active": {
                    ...
                    "key_auths": [
                        [
                            "DWB6LUoAA8gCL9tHRz7v9xcwR4ZWD3KDRHP5t1U7UAZHdfanLxyBE",
                            1
                        ]
                    ]
                },
                "posting": {
                    ...
                    "key_auths": [
                        [
                            "DWB8anmpHdfVE4AmwsDpcSXpRsydHysEbv6vGJkRQy1d1CC83zeTA",
                            1
                        ]
                    ]
                },
                "memo_key": "DWB67RYDyEkP1Ja1jFehJ45BFGA9oHHUnRnYbxKJEtMhVQiHW3S3k",
                "json_metadata": "{}",
                "extensions": [],
                "prefix": default_prefix,
            })
...
"""
    ...
    def test_transfer(self):
        ...
        fee = objects.Asset(amount=0, asset_id="BBD")
