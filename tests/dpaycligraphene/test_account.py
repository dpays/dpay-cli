...
from dpaycligraphenebase.account import BrainKey, Address, PublicKey, PrivateKey, PasswordKey
...
class Testcases(unittest.TestCase):
    ...
    def test_PasswordKey(self):
        ...
        for i, pwd in enumerate(a):
            p = format(PasswordKey("xeroc", pwd, "posting").get_public(), "DWB")
    ...
    def test_Privatekey_derive(self):
        ...
        self.assertEqual([format(p1.child(p2.get_secret()), "DWB"),
