...
.. image:: _static/dpaycli-logo.svg
   :width: 300 px
   :alt: dpaycli
   :align: center

Welcome to dpaycli's documentation!
================================
...
The dpaycli library has been designed to allow developers to easily
...
The purpose of *dpaycli* is to simplify development of products and
