...
Setting Defaults
----------------
For a more convenient use of ``dpay`` as well as the ``dpaycli`` library, you can set some defaults.
...
::
   ...
   Commands:
     ...
     convert                 Convert BEXDollars to DPay (takes a week...
