...
.. code-block:: python
    ...
    print("Rewards are %.3f BP" % curation_rewards_SP)
...
.. code-block:: python
    ...
    from dpaycli.account import Account
    from dpaycli.comment import Comment
    from dpaycli.exceptions import ContentDoesNotExistsException
...
Transactionbuilder
------------------
Sign transactions with dpaycli without using the wallet and build the transaction by hand.
