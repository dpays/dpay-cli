...
if __name__ == "__main__":
    ...
    plt.plot_date(timestamps, curation_per_1000_SP, label="Curation reward per week and 1k BP", **opts)
    plt.grid()
    plt.legend()
    ...
    print("last curation reward per week and 1k bp %.2f BP" % (curation_per_1000_SP[-1]))
